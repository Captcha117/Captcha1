...
/**
 * Super class for all external events. All new classes of external events must extend this class. This can also be used as a dummy event if only an update request (and
 * no further actions) to all hosts is needed.
 */
