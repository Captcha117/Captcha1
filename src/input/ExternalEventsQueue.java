...
public class ExternalEventsQueue implements EventQueue
{
	 ...
	 * 
	 * @param filePath
	 *            Path to the file where the events are read from. If file ends with extension defined in {@link BinaryEventsReader#BINARY_EXT} the file is assumed to be
	 *            a binary file.
	 * @param nrofPreload
	 *            How many events to preload
	...
	/**
	 * Create a new Queue based on the given settings: {@link #PRELOAD_SETTING} and {@link #PATH_SETTING}. The path setting supports value filling.
	 * 
	 * @param s
	 *            The settings
	 */
	 ...
	 * 
	 * @param nrof
	 *            Maximum number of events to read. If less than 1, default value ( {@value DEFAULT_NROF_PRELOAD} ) is used.
	 */
