...
public class ConnectionEvent extends ExternalEvent
{
	 ...
	 * @param interf
	 *            The number of interface for the connection
	 * @param up
	 *            If true, this was a "connection up" event, if false, this was a "connection down" event
	 * @param time
	...
	{
		return "CONN " + (isUp ? "up" : "down") + " @" + this.time + " " + this.fromAddr + "<->" + this.toAddr;
	}
}
