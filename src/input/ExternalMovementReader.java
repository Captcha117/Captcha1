 ...
 * <P>
 * First line of the file should be the offset header. Syntax of the header should be:<BR>
 ...
 * where <CODE>time</CODE> is the time when a node with <CODE>id</CODE> should be at location <CODE>(xPos, yPos)</CODE>.
 * </P>
 * <P>
...
public class ExternalMovementReader
{
	...
	public List<Tuple<String, Coord>> readNextMovements()
	{
		...
		if (!scanner.hasNextLine())
		{ // add the last tuple of the file
			moves.add(new Tuple<String, Coord>(id, new Coord(x, y)));
		}
