...
public class MessageRelayEvent extends MessageEvent
{
	...
	{ "SENDING", "TRANSFERRED", "ABORTED" };

	/**
	 * Creates a message relaying event
	 * 
	 * @param from
	 *            Where the message comes from (at this hop)
	 * @param to
	 *            Who the message goes to (at this hop)
	 * @param id
	 *            ID of the message
	 * @param time
	 *            Time when this event happens
	 * @param stage
	 *            The stage of the event (SENDING, TRANSFERRED, or ABORTED)
	 */
	...
	{
		return super.toString() + " [" + fromAddr + "->" + toAddr + "] " + STAGE_STRINGS[stage - 1];
	}
