...
/**
 * The DTN2Reporter class is responsible for delivering bundles from The ONE to dtnd. To enable DTN2 connectivity, the class must be specified in the configuration file
 * as a report class.
 * 
 * @author teemuk
 */
public class DTN2Reporter extends Report implements MessageListener
{
	 ...
	 * @param firstDelivery
	 *            Was the target node final destination of the message and received this message for the first time.
	 */
	public void messageTransferred(Message m, DTNHost from, DTNHost to, boolean firstDelivery)
	{
		if (firstDelivery)
		{
			...
			if (p != null)
			{ // Check that there's a CLA connected to this node
