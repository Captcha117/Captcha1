...
/**
 * Report for of amount of messages delivered vs. time. A new report line is created every time when either a message is created or delivered. Messages created during the
