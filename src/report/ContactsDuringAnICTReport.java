...
/**
 * The number of contacts during an inter-contact time metric is similar to the inter-contact times metric, except that instead of measuring the time until a node meets
 * again, we count the number of other nodes both of the nodes meet separately. In contrast to the inter-contact times, the number of contacts during an inter-contact is
 * not symmetric, i.e. during an inter-contact both nodes wait the exact same time but will meet a different number of nodes.
 * 
 * @author Frans Ekman
 */
public class ContactsDuringAnICTReport extends Report implements ConnectionListener, UpdateListener
{
