...
/**
 * Reporter for the <code>FloatingApplication</code>. Provides information about when a node enters/leaves a specific anchor zone
 *
 * This is only used for the "flux" mode of operation to assess how many nodes enter and leave a single anchor zone.
 * 
 * @author jo
 */
