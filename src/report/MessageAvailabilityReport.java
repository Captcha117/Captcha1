...
/**
 * Reports which messages are available (either in the buffer or at one of the connected hosts' buffer) for certain, randomly selected, tracked hosts. Supports the same
 * settings as the {@link MessageLocationReport}
 */
public class MessageAvailabilityReport extends MessageLocationReport
{

	/**
	 * Number of tracked hosts -setting id ({@value}). Defines how many hosts are selected for sampling message availability
	 */
	...
	private Set<DTNHost> selectTrackedHosts(List<DTNHost> allHosts)
	{
		...
		{
			throw new SettingsError("Can't use more hosts than there are " + "in the simulation scenario");
		}
	 ...
	 * 
	 * @param trackedHosts
	 *            The list of hosts in the world
	 */
	@Override
