...
/**
 * Reports information about all created messages. Messages created during the warm up period are ignored. For output syntax, see {@link #HEADER}.
 */
public class CreatedMessagesReport extends Report implements MessageListener
{
	...
	public void newMessage(Message m)
	{
		...
		int ttl = m.getTtl();
		write(format(getSimTime()) + " " + m.getId() + " " + m.getSize() + " " + m.getFrom() + " " + m.getTo() + " " + (ttl != Integer.MAX_VALUE ? ttl : "n/a")
				+ (m.isResponse() ? " Y " : " N "));
	}
