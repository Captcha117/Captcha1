...
/**
 * Reports the inter-contact time (i.e., the time between the end of previous contact and the beginning of a new contact between two hosts) distribution. The syntax of
 * the report file is the same as in {@link ContactTimesReport}.
 */
