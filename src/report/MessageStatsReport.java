 ...
 * <P>
 * <strong>Note:</strong> if some statistics could not be created (e.g. overhead ratio if no messages were delivered) "NaN" is reported for double values and zero for
 * integer median(s).
 */
