...
/**
 * Report for total amount of contact times among hosts. Reports how long all nodes have been in contact with some other node. Supports
 * {@link ContactTimesReport#GRANULARITY} setting. If update interval is smaller than 1.0 seconds, time stamps may start to drift. Reported values still correspond to
 * reported times. Connections that started during the warmup period are ignored.
 */
public class TotalContactTimeReport extends ContactTimesReport implements UpdateListener
{
	...
	/**
	 * Reports total contact time if more time than defined with setting {@link ContactTimesReport#GRANULARITY} has passed. Method is called on every update cycle.
	 */
