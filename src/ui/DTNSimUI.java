...
public abstract class DTNSimUI
{
	...
	/**
	 * Report class name -setting id prefix ({@value}). Defines name(s) of the report classes to load. Must be suffixed with numbers starting from one.
	 */
	public static final String REPORT_S = "Report.report";
	/**
	 * Movement model warmup time -setting id ({@value}). Defines how many seconds of movement simulation is run without connectivity etc. checks before starting the real
	 * simulation.
	 */
