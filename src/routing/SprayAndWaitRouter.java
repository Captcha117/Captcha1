...
/**
 * Implementation of Spray and wait router as depicted in <I>Spray and Wait: An Efficient Routing Scheme for Intermittently Connected Mobile Networks</I> by Thrasyvoulos
 * Spyropoulus et al.
 *
 */
public class SprayAndWaitRouter extends ActiveRouter
{
	...
	/**
	 * Called just before a transfer is finalized (by {@link ActiveRouter#update()}). Reduces the number of copies we have left for a message. In binary Spray and Wait,
	 * sending host is left with floor(n/2) copies, but in standard mode, nrof copies left is reduced by one.
	 */
	@Override
