...
/**
 * Passive router that doesn't send anything unless commanded. This is useful for external event -controlled routing or dummy nodes. For implementation specifics, see
 * MessageRouter class.
 */
