...
public class ScheduleEntry implements Serializable
{
	 ...
	 * 
	 * @param time
	 *            When the journey from "from" starts
	 * @param from
	 *            The source
	 * @param via
	 *            The node that takes us there (or -1 if n/a)
	 * @param to
	 *            The destination
	 * @param duration
	 *            Time it takes from the source to destination
	 */
	...
	{
		return time + "(+" + delta + "): " + from + "->" + (via > 0 ? via + "->" : "") + to + " (" + duration + ")";
	}
