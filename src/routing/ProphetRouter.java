...
public class ProphetRouter extends ActiveRouter
{
	...
	/**
	 * Number of seconds in time unit -setting id ({@value}). How many seconds one time unit is when calculating aging of delivery predictions. Should be tweaked for the
	 * scenario.
	 */
