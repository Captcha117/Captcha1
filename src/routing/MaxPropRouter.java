 ...
 * @version 1.0
 * 
 *          Extension of the protocol by adding a parameter alpha (default 1) By new connection, the delivery likelihood is increased by alpha and divided by 1+alpha.
 *          Using the default results in the original algorithm. Refer to Karvo and Ott, <I>Time Scales and Delay-Tolerant Routing Protocols</I> Chants, 2008
 */
public class MaxPropRouter extends ActiveRouter
{
	...
	/**
	 * Meeting probability set maximum size -setting id ({@value}). The maximum amount of meeting probabilities to store.
	 */
	...
	public void changedConnection(Connection con)
	{
		...
		{ // new connection
			...
			if (con.isInitiator(getHost()))
			{
				...
				assert mRouter instanceof MaxPropRouter : "MaxProp only works " + " with other routers of same type";
	...
	private Tuple<Message, Connection> tryOtherMessages()
	{
		...
		for (Connection con : getConnections())
		{
			...
			for (Message m : msgCollection)
			{
				...
				/*
				 * skip message if this host has already sent it to the other host (regardless of if the other host still has it)
				 */
