...
/**
 * <P>
 * Epidemic message router with an oracle that tells when a message is delivered and that message is then removed from all nodes that use this routing module. This router
 * also <B>ignores message size and all messages are delivered immediately</B>.
 * </P>
 * <P>
...
public class EpidemicOracleRouter extends ActiveRouter
{
	...
	/**
	 * Removes the message with the given ID from this router, if the router has that message; otherwise does nothing. If the router was transferring the message, the
	 * transfer is aborted.
	 * 
	 * @param id
