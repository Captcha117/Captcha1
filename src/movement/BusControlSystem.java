...
public class BusControlSystem
{
	...
	/**
	 * Called by busses belonging to this system every time the bus has stopped. It calls every passengers enterBus() method so that the passengers can enter the bus if
	 * they want to.
	 * 
	 * @param busID
	 *            Unique identifier of the bus
	 * @param busStop
	 *            Coordinates of the bus stop
	 * @param nextPath
	 *            The path to the next stop
	 */
