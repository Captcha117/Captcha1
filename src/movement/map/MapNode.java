...
public class MapNode implements Comparable<MapNode>
{
	 ...
	 * 
	 * @param type
	 *            An integer from range [{@value MIN_TYPE}, {@value MAX_TYPE}]
	 */
	 ...
	 * 
	 * @param type
	 *            The type (integer from range [{@value MIN_TYPE}, {@value MAX_TYPE}])
	 ...
	 * 
	 * @param types
	 *            The types to check (array of values in range [{@value MIN_TYPE}, {@value MAX_TYPE}])
	 ...
	 * 
	 * @param node
	 *            The node to add or null for no action
	 */
