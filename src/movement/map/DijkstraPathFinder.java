...
public class DijkstraPathFinder
{
	 ...
	 * 
	 * @param okMapNodes
	 *            The map node types that are OK for paths or null if all nodes are OK
	 */
	 ...
	 * @return a shortest path between the source and destination nodes in a list of MapNodes or an empty list if such path is not available
	 */
	...
	private class DistanceMap
	{
		...
		/**
		 * Returns the distance to a node. If no distance value is found, returns {@link DijkstraPathFinder#INFINITY} as the value.
		 * 
		 * @param node
