...
public class EveningTrip
{
	 ...
	 * 
	 * @param nrOfeveningActivityNodes
	 *            The number of shoppers in the group
	 * @param location
	 *            Where the trip starts
	 */
	public EveningTrip(int nrOfeveningActivityNodes, Coord location)
	{
		eveningActivityNodes = new EveningActivityMovement[nrOfeveningActivityNodes];
	...
	public boolean addNode(EveningActivityMovement eveningActivityNode)
	{
		...
		{
			eveningActivityNodes[eveningActivityNodesInBuffer] = eveningActivityNode;
