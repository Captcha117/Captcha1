...
public abstract class ExtendedMovementModel extends MovementModel
{
	...
	/**
	 * Method is called between each getPath() request when the current MM is ready (isReady() method returns true). Subclasses should implement all changes of state that
	 * need to be made here, for example switching mobility model, etc.
	 * 
