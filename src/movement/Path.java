...
public class Path
{
	...
	/**
	 * Copy constructor. Creates a copy of this path with a shallow copy of the coordinates and speeds.
	 * 
	 * @param path
	 *            The path to create the copy from
	 */
	 ...
	 *            The waypoint
	 * @param speed
	 *            The speed towards that waypoint
	 */
