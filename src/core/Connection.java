...
public abstract class Connection
{
	...
	protected DTNHost fromNode;//连接的源节点
	protected NetworkInterface fromInterface;//连接的源接口
	protected DTNHost msgFromNode;//消息的源节点

	private boolean isUp;//连接的当前状态
	protected Message msgOnFly;//连接正在传输的消息
	...
	/**
	 * Finalizes the transfer of the currently transferred message. The message that was being transferred can <STRONG>not</STRONG> be retrieved from this connections
	 * after calling this method (using {@link #getMessage()}).
	 */
