...
/**
 * Intermodule communication bus. Works as a blackboard where modules can post data, subscribe to data changes and also poll for data values. This is fairly similar to
 * Message class' property interface, but these values are shared for a node instead of message.
 */
public class ModuleCommunicationBus
{
	...
	/**
	 * Adds a new property for this node. The key can be any string but it should be such that no other class accidently uses the same value. Note that, unless the value
	 * is immutable, it can be changed by any object that can call {@link #getProperty}.
	 * 
	 * @param key
	 ...
	 * 
	 * @param key
	 *            The key for which a value's existence is checked
	 ...
	 * 
	 * @param key
	 *            The key of variable to update
	 * @param delta
	 *            Value added to the old value
	 * @return The new value
	 * @throws SimError
	 *             if the value with the given key was not a Double
	 */
	 ...
	 * @return The value of the key, or the naValue if they key was not found
	 * @throws SimError
	 *             if the value with the given key was not an Integer
	 */
	 ...
	 * 
	 * @param key
	 *            The key of the value whose changes the module is interested of
	 * @param module
	 *            The module to subscribe.
	 */
	public void subscribe(String key, ModuleCommunicationListener module)
	{
		if (this.listeners == null)
		{
			...
			this.listeners = new HashMap<String, List<ModuleCommunicationListener>>();
		}
	 ...
	 * 
	 * @param key
	 *            The key for which the subscription should be removed
	 * @param module
	 *            The module to whose subscription is removed
	 */
