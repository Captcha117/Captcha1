...
public class SimScenario implements Serializable
{
	...
	protected SimScenario()
	{
		...
		this.world = new World(hosts, worldSizeX, worldSizeY, updateInterval, updateListeners, simulateConnections, eqHandler.getEventQueues());
	}
	...
	protected void createHosts()
	{
		...
		for (int i = 1; i <= nrofGroups; i++)
		{
			...
			for (int j = 0; j < nrofHosts; j++)
			{
				...
				DTNHost host = new DTNHost(this.messageListeners, this.movementListeners, gid, interfaces, comBus, mmProto, mRouterProto);
				hosts.add(host);
			}
		}
	}
