...
public class NodeChooser extends JPanel implements ActionListener
{
	...
	/**
	 * Default message node filters -setting id ({@value}). Comma separate list of message IDs from which the default filter set is created.
	 */
	...
	private void updateShownNodes()
	{
		...
		if (nodes.size() == oldShownNodes.size() && oldShownNodes.containsAll(shownNodes))
		{
	 ...
	 * 
	 * @param offset
	 *            Index of the first node to show
	 */
