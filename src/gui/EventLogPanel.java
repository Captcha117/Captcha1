...
public class EventLogPanel extends JPanel implements ConnectionListener, MessageListener, ActionListener
{
	...
	/**
	 * Regular expression filter -setting id ({@value}). Defines the regular expression against which the event texts are matched; only matching events are not shown
	 */
	 ...
	 * 
	 * @param check
	 *            EventLogControls used to check if this entry type should be shown and/or paused upon
	 * @param name
