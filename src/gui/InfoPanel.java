...
public class InfoPanel extends JPanel implements ActionListener
{
	 ...
	 * 
	 * @param host
	 *            Host to show the information of
	 */
	 ...
	 * 
	 * @param message
	 *            Message to show the information of
	 */
	...
	{
		int ttl = m.getTtl();
		String txt = " [" + m.getFrom() + "->" + m.getTo() + "] " + "size:" + m.getSize() + ", UI:" + m.getUniqueId() + ", received @ "
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			if (msgChooser.getSelectedIndex() == 0)
			{ // title text selected
				return;
			}
