...
public class EventLogControl
{
	 ...
	 * 
	 * @param show
	 *            The checkbox that controls showing this type of event
	 * @param pause
	 *            The checkbox that controls pausing on this type of event
	 */
	 ...
	 * 
	 * @param show
	 *            If true, events are set to be shown
	 */
