...
public class MainWindow extends JFrame
{
	...
	/**
	 * Window width -setting id ({@value}). Defines the width of the GUI window. Default {@link #WIN_DEFAULT_WIDTH}
	 */
	public static final String WIN_WIDTH_S = "width";
	/**
	 * Window height -setting id ({@value}). Defines the height of the GUI window. Default {@link #WIN_DEFAULT_HEIGHT}
	 */
	...
	public MainWindow(String scenName, World world, PlayField field, GUIControls guiControls, InfoPanel infoPanel, EventLogPanel elp, DTNSimGUI gui)
	{
		...
		logControlSplit = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, new JScrollPane(elp.getControls()), new JScrollPane(elp));
		...
		setPreferredSize(new Dimension(s.getInt(WIN_WIDTH_S, WIN_DEFAULT_WIDTH), s.getInt(WIN_HEIGHT_S, WIN_DEFAULT_HEIGHT)));
