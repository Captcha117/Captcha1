...
public class EventLogControlPanel extends JPanel implements ActionListener
{
	 ...
	 *            Name of the control
	 * @param showOn
	 *            Is "show" initially selected
	 * @param pauseOn
	 *            Is "pause" initially selected
	 ...
	 * @param endOfRow
	 *            Is the box last in the row in the layout
	...
	/**
	 * Adds a new heading in the control panel. Subsequent addControl controls will be under this heading
	 * 
	 * @param name
	 *            The heading text
	 */
