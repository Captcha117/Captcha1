...
public class TestUtils
{
	 ...
	 */
	public TestUtils(List<ConnectionListener> cl, List<MessageListener> ml, TestSettings settings)
	{
	...
	public DTNHost createHost(MovementModel mmProto, String name)
	{
		...
		li.add(ni);
		DTNHost host = new DTNHost(msgListeners, null, groupId, li, comBus, mmProto, mr);
		if (name != null)
		{
			host.setName(name);
		}
