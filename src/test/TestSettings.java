...
public class TestSettings extends core.Settings
{
	...
	public TestSettings()
	{
		...
		/*
		 * put some test setting values to the Settings. These can be later overridden by calls to putSetting(String, String)
		 */
		...
		putSetting(MovementModel.MOVEMENT_MODEL_NS + "." + MovementModel.WORLD_SIZE, "1000,1000");
	}
