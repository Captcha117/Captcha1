...
public class TestInterface extends NetworkInterface
{
	...
	{
		Connection con = new CBRConnection(this.getHost(), this, anotherInterface.getHost(), anotherInterface, transmitSpeed);
	...
	/**
	 * Creates a connection to another host. This method does not do any checks on whether the other node is in range or active (cf. {@link #connect(DTNHost)}).
	 * 
	 * @param anotherHost
