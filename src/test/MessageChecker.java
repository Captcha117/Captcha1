...
public class MessageChecker implements MessageListener
{
	...
	private void add(Message m, DTNHost from, DTNHost to, String type, Boolean dropped, Boolean delivered)
	{
	...
	private class MsgCheckerEvent
	{
		...
		public MsgCheckerEvent(Message m, DTNHost from, DTNHost to, String type, Boolean dropped, Boolean delivered)
		{
			this.msg = m;
			this.from = from;
			this.to = to;
