...
public class ScheduleDijkstraTest extends TestCase
{
	...
	public void testSimplePaths()
	{
		...
		comparePaths(new int[]
		{ 1, 2, 10 }, d.getShortestPath(1, 10, 0));
		...
		comparePaths(new int[]
		{ 1, 3, 10 }, d.getShortestPath(1, 10, 0));
		...
		comparePaths(new int[]
		{ 1, 4, 10 }, d.getShortestPath(1, 10, 0));
	}
	...
	public void testMultipleHops()
	{
		...
		comparePaths(new int[]
		{ 1, 3, 10, 20 }, d.getShortestPath(1, 20, 0));

		/* bit later via 11 but faster */
		oracle.addEntry(65, 11, 20, 3);
		comparePaths(new int[]
		{ 1, 3, 11, 20 }, d.getShortestPath(1, 20, 0));
