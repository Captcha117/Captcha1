...
public class SettingsTest extends TestCase
{
	...
	private static final int[] CSV_RS_V =
	{ 1, 2, 3, 4 };

	private static final String TST = "tstSetting";
	private static final String TST_RES = "tst";
	private static final String[] INPUT =
	{ "Ns.setting1 = 1", "Ns.setting2 = true", TST + " = " + TST_RES, "tstSetting2 = tst2", "double = 1.1", "csvDoubles = 1.1,2.2,3.3", "csvInts 1,2,3",
			"booleanTrue = true", "booleanFalse = false", "int = 1", "runSetting = [val1 ; val2;val3; val4 ]", IRS_S + " = [val1 ; val2",
			CSV_RS_S + " = [" + CSV_RS_V[0] + "," + CSV_RS_V[1] + ";" + CSV_RS_V[2] + "," + CSV_RS_V[3] + "]", "Ns.runSetting = [ ; ; 2; ]", "DefNs.runSetting = 1"
