...
public class MaxPropRouterTest extends AbstractRouterTest
{
	...
	public void testCostValues()
	{
		...
		assertEquals(1.0, (1 - r1.getCost(h1, h2)) + (1 - r1.getCost(h1, h3)) + (1 - r1.getCost(h1, h4)));
	...
	public void testThreshold()
	{
		...
		assertEquals(2, r2.calcThreshold());
		/*
		 * msg at h3 has traveled 2 hops and "bsize > avgTransferredBytes > 0" so threshold should be only msg's hopcount+1
		 */
	...
	public void testAckedMessageDeleting()
	{
		...
		assertFalse(mc.next());
		/*
		 * msgId2 should NOT be deleted but it should be transferred to h2 during the next update
		 */
	...
	public void testRouting()
	{
		...
		disconnect(h3);
		/*
		 * h3 probs: h4:0.5, th2:0.5 h4 probs: h3:0.5, th1:0.375, h5:0.125
		 */
		...
		disconnect(h2);
		/*
		 * h2 probs: th3:0.875, h3:0.125 h3 probs: h2:0.5, h4:0.25, th2:0.25
		 */
		...
		disconnect(h1);
		/*
		 * h1 probs: th4:0.5, h2:0.5 h2 probs: h1:0.5, th3:0.4375, h3:0.0625
		 */

		h4.connect(h5);
		disconnect(h4);
		/*
		 * h4 probs: h3:0.25, th1:0.1875, h5:0.5625 these changes should not be visible to h3!
		 */
		Message m1 = new Message(h1, h5, msgId1, msgSize);
		h1.createNewMessage(m1);
	...
	public void testMpsTimeStamps()
	{
		...
		disconnect(h1);
		/*
		 * now we should have h1': h2:1.0; h2:h2' h2': h1:1.0; h1:h1'
		 */
		...
		disconnect(h1);
		/*
		 * h1'': h2:0.5, h3:0.5; h2:h2', h3:h3' h3': h1:1.0; h1:h1'', h2:h2'
		 */
		...
		disconnect(h1);
		/*
		 * h1''': h2:0.25, h3:0.25, h4:0.5; h2:h2', h3:h3', h4:h4' h4': h1:1.0; h1:h1''', h2:h2', h3:h3'
		 */
		...
		disconnect(h2);
		/*
		 * h2'': h1:0.5, h3:0.5; h1:h1'', h3:h3'' (both from h3) h3'': h1:0.5, h2:0.5; h1:h1'', h2:h2'' (h1's probs should remain)
		 */
		...
		disconnect(h1);
		/*
		 * h1'''': h2:0.625, h3:0.125, h4:0.25; h2:h2''', h3:h3'', h4:h4' h2''': h1:0.75, h3:0.25; h1:h1'''', h2:h3'', h4:h4'
		 */
