...
public class MaxPropDijkstraTest extends TestCase
{
	...
	public void setUp() throws Exception
	{
		...
		for (int i = 0; i < NROF_HOSTS; i++)
		{
			...
			MeetingProbabilitySet set = new MeetingProbabilitySet(MeetingProbabilitySet.INFINITE_SET_SIZE, 1.0);
			msets.add(set);
			hostsSet.add(host);
	...
	public void testProbabilitySumsToOne()
	{
		...
		for (int i = 0; i <= 3; i++)
		{
			...
			assertEquals("Total sum for node " + i + " was " + total, 1.0, total, DELTA);
		}
